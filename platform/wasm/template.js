	...
	WebAssembly.instantiate(array, imports).then(
		function(wa) { 
			...
			if( instance.exports.HandleButton )
			{
                ...
                canvas.addEventListener('touchstart', e => { e.preventDefault(); instance.exports.HandleButton( e.touches[0].clientX, e.touches[0].clientY, 0, 1 ); } );
				canvas.addEventListener('touchend', e => { e.preventDefault(); instance.exports.HandleButton( e.touches[0].clientX, e.touches[0].clientY, 0, 0 ); } );
				canvas.addEventListener('touchcancel', e => { e.preventDefault(); instance.exports.HandleButton( e.touches[0].clientX, e.touches[0].clientY, 0, 0 ); } );
            }
