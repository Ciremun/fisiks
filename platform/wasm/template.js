	...
	WebAssembly.instantiate(array, imports).then(
		function(wa) { 
			...
			if( instance.exports.HandleButton )
			{
                ...
                canvas.addEventListener('touchstart', e => { instance.exports.HandleButton( e.touches[0].clientX, e.touches[0].clientY, 0, 1 ); } );
				canvas.addEventListener('touchend', e => { instance.exports.touchend(); } );
				canvas.addEventListener('touchcancel', e => { instance.exports.touchend(); } );
            }
